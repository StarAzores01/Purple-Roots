...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header('Location: ../profile.php?product_added=success');
    exit;
}
?>
...
<div class="dashboard-shell">
    ...
    <main class="dashboard-main">
        ...
        <!-- Form -->
        <form method="post" class="form-card auth-card-enhanced" style="max-width:900px">
            <div class="alert alert-light border mb-4">
                <strong>Product posting access:</strong> farmers/cooperatives and corporate sellers can add records. New entries start as Pending or For Validation until verified by the platform administrator.
            </div>
            <div class="row g-3">

                <div class="col-md-6">
                    <label class="form-label">Owner / user level</label>
